...
INSTANTIATE_ATTENTION_KERNEL_FORWARD_SM86(float, false, 32, 128, true);
INSTANTIATE_ATTENTION_KERNEL_FORWARD_SM86(float, false, 32, 128, false);
INSTANTIATE_ATTENTION_KERNEL_FORWARD_SM86(float, false, 64, 64, true);
#endif
